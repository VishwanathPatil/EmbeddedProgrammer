/**
 * This program will fail to compile because there is no reason to dynamic cast around since no virtual functions
 *
 * dynamic_cast_fail_compile.cpp:34:25: error: cannot ‘dynamic_cast’ ‘base1_obj’ (of type ‘class Base1*’) to type ‘class Derived1*’ (source type is not polymorphic)
   34 |          derived1_obj = dynamic_cast<Derived1 *> (base1_obj); 
 **/
